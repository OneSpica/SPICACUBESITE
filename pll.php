            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="alg-card">
                    <div class="card-header-spica">
                        ...
                        <span class="alg-badge"><?php echo $row['type']; ?></span>
                    </div>
                    ...
                    <div class="card-footer-spica d-flex justify-content-between align-items-center">
                        <span class="text-muted small"><?php echo $row['move_count']; ?> Moves</span>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content"
                            ...
                            <div class="modal-body text-center p-5 pt-0"> <!-- Added pt-0 to keep spacing tight -->
                                ...
                                <h2 class="fw-bold text-white mb-3"><?php echo htmlspecialchars($row['alg_name']); ?></h2>
